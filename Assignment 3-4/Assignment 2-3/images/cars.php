...
<div class="container-fluid padding">
  ...
  <div class="col-lg-3">
      ...
      <div class="col-lg-3">
         <?php
        $sql = "SELECT * FROM `Cars` WHERE id='4'";
        $sth = $db->query($sql);
        $result=mysqli_fetch_array($sth);
        echo '<img src="data:image/jpeg;base64, '.base64_encode( $result['Picture'] ).'"width="300" height="200"/>';
        echo  '<br> Model:  ' .$result['Model'];
  ...
  <div class="col-lg-3">
         <?php
        $sql = "SELECT * FROM `Cars` WHERE id='5'";
        $sth = $db->query($sql);
        $result=mysqli_fetch_array($sth);
        echo '<img src="data:image/jpeg;base64, '.base64_encode( $result['Picture'] ).'"width="300" height="200"/>';
        echo  '<br> Model:  ' .$result['Model'];
  ...
  <div class="col-lg-3">
         <?php
        $sql = "SELECT * FROM `Cars` WHERE id='6'";
        $sth = $db->query($sql);
        $result=mysqli_fetch_array($sth);
        echo '<img src="data:image/jpeg;base64, '.base64_encode( $result['Picture'] ).'"width="300" height="200"/>';
        echo  '<br> Model:  ' .$result['Model'];
  ...
  <div class="col-lg-3">
         <?php
        $sql = "SELECT * FROM `Cars` WHERE id='7'";
        $sth = $db->query($sql);
        $result=mysqli_fetch_array($sth);
        echo '<img src="data:image/jpeg;base64, '.base64_encode( $result['Picture'] ).'"width="300" height="200"/>';
        echo  '<br> Model:  ' .$result['Model'];
  ...
  <div class="col-lg-3">
         <?php
        $sql = "SELECT * FROM `Cars` WHERE id='9'";
        $sth = $db->query($sql);
        $result=mysqli_fetch_array($sth);
        echo '<img src="data:image/jpeg;base64, '.base64_encode( $result['Picture'] ).'"width="300" height="200"/>';
        echo  '<br> Model:  ' .$result['Model'];
